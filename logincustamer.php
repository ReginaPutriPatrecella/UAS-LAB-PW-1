  ...
  <header id="header" class="fixed-top">
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="container">
			<section class="main">
				<form action="logincustamer_proses.php" method="post" class="form-4">
				    <h1>Login <br> PT.Garuda Indonesia</h1>
				    <p>
				        <label for="username">Masukkan Username</label>
				        <input type="text" name="username" placeholder="Username Kamu" id="username" required>
				    </p>
